-- Exportování struktury pro tabulku customs.gv_teleport_menu
DROP TABLE IF EXISTS `customs`.`gv_teleport_menu`;
CREATE TABLE IF NOT EXISTS `customs`.`gv_teleport_menu` (
  ...
  `expansion_required` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_entry` (`teleporter_entry`),
  KEY `idx_sort` (`teleporter_entry`,`sort_index`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Exportování dat pro tabulku customs.gv_teleport_menu
INSERT INTO `customs`.`gv_teleport_menu` (`id`, `teleporter_entry`, `label_cs`, `label_en`, `x`, `y`, `z`, `o`, `sort_index`, `expansion_required`) VALUES
